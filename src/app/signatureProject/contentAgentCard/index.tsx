    ...
    <div className=" h-fit p-5 mt-5 border-2 border-gray-2 rounded-xl bg-[#c2d6ef]">
      ...
      <div className="flex flex-col gap-5 mt-5">
        ...
        <input
          ...
          className="border-2 border-gray-2 p-3 w-full rounded-xl"
        />
        <input
          type="email"
        ...
        />
        <textarea
          className="p-4 resize-none border-2 border-gray-2 rounded-xl"
          name=""
          id=""
          placeholder="You can type your message here, our agent will get back to you."
        ></textarea>
        <button className="bg-[#9f3323] rounded-lg flex  gap-4 items-center justify-center text-white py-3 px-5 font-bold text-[14px]">
          SUBMIT{" "}
          <Image
        ...
        <div className="flex gap-5 justify-center">
          <button className="flex gap-2 border-2 border-gray-2 p-3 text-[14px] text-[#1e2a45] rounded-xl">
            WHATSAPP{" "}
            <div>
              <Image
