...
export const ItemRight = ({ image, title }: any) => {
  return (
    <div className="bg-white relative rounded-2xl overflow-hidden flex flex-col-reverse md:flex-row shadow-lg border border-[#9f351773]">
      ...
      <div className="h-60 right-0 top-0 w-full md:w-1/3 relative">
        <img
          src={image || "/images/white-house.jpg"}
          alt="property"
          className="h-full w-full z-0 object-cover"
        />
        <div className="absolute h-full left-0 top-0 w-full z-10 bg-gradient-to-r from-white to-transparent  hidden md:block"></div>
      </div>
    </div>
  );
};
