...
export const Item = () => {
  return (
    <div className="border border-[#9f3517] shadow-md px-10 py-12 rounded-lg text-center flex flex-col items-center gap-1">
      <img
      ...
      <p className="text-xs font-light opacity-80 text-[#9f3517]">Property Agent</p>
