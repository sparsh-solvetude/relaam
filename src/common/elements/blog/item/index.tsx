...
export const Item = ({ title, slug, image, date, time, type }: any) => {
  return (
    <Link href={`/${types[type]}/${slug}`}>
      <div className="bg-white rounded-xl flex flex-col gap-1 relative h-full shadow-lg border border-[#9f351773] hover:border-[#9f3517] transition-all duration-300 cursor-pointer">
